...
<div class="sidebar">
    ...
    <form method="POST" action="{{ route('logout') }}">
        @csrf
        <button class="logout-btn" type="submit">Logout ({{ auth()->user()->name }})</button>
    </form>
</div>
...
<div class="chat-area">
    ...
    <div id="messages">
        @foreach ($messages as $msg)
            <div class="message {{ $msg->user_id === auth()->id() ? 'own' : '' }}">
                ...
                <div class="bubble">
                    ...
                    <div class="bubble-time">{{ $msg->created_at->diffForHumans() }}</div>
                </div>
            </div>
        @endforeach
    </div>
